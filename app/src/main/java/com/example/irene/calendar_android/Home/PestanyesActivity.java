...
//public class PestanyesActivity extends AppCompatActivity {
public class PestanyesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pestanyes);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        //Fer visible el boto per tornar en el menu principal (Navigation Drawer)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    CalendariFragment calendariFragment = new CalendariFragment();
                    return calendariFragment;
                case 1:
        ...
        //Quantitat de pestanyes que volem que és mostri en el nostre MainActivity (Navigation Drawer)
        @Override
        public int getCount() {
            return 2; // 2 pestanyes
        }
        //Titol de les pestanyes que volem mostrar
        @Override
