...
public class ActivityAfegirUsuariEvent extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ActivityAfegirUsuariEvent.this, ActivityLlistatUserEvents.class);
                    ...
                    switch (id){
                        case R.id.btnAfegirUsuari:
                            try{
                                ...
                                apiConnector.PUT("Company/Group/Date/User", jsonObject, new Request() {
                                    ...
                                    public void Response(Object o) {
                                        ...
                                        try{
                                            ...
                                            if(res.getBoolean("valid")){
                                                Intent i = new Intent(ActivityAfegirUsuariEvent.this, ActivityLlistatUserGrups.class);
                                                i.putExtra("company_uuid", company_uuid);
                                                i.putExtra("group_id", group_id);
                                                i.putExtra("date_id", date_id);
                                                startActivity(i);
                        ...
                        case R.id.btnEliminarUsuari:
                            try{
                                ...
                                apiConnector.DELETE("Company/Group/Date/User", jsonObject, new Request() {
